...
const Services = (props: Props) => {
  ...
  return (
    <div className={`${lobster.className} w-10/12 mx-auto my-10`}>
      <h1 className='md:text-4xl text-3xl lg:text-5xl font-bold mb-10'>Our Products</h1>
      <motion.div variants={variants} initial='hidden' whileInView='visible' viewport={{ once: true }} className='flex max-md:flex-wrap gap-7 justify-between'>
        <motion.div variants={child} className='d p-5 relative overflow-hidden mt-5'>
          <h1 className='text-center mt-5'>Stylish Apparel</h1>
          <div className='flex justify-center mt-4'>
            <MdDesignServices className='text-pink-600' size={28} />
          </div>
          <p className='text-center mt-10 text-neutral-300'>Discover our range of stylish apparel that keeps you trendy and comfortable.</p>
          <p className='text-center mt-10 mb-7'><a href="#" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-green-500'>Shop Now</a></p>
        ...
        <motion.div variants={child} className='d p-5 relative overflow-hidden mt-5'>
          <h1 className='text-center mt-5'>Latest Gadgets</h1>
          <div className='flex justify-center mt-4'>
            <MdDeveloperMode className='text-blue-600' size={28} />
          </div>
          <p className='text-center mt-10 text-neutral-300'>Explore our collection of the latest gadgets to keep you ahead of the curve.</p>
          <p className='text-center mt-10 mb-7'><a href="#" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-green-500'>Shop Now</a></p>
          <span className='w-[60px] h-[60px] z-[-2] blur-[100px] left-[45%] bg-white absolute top-0 '></span>
        ...
        <motion.div variants={child} className='d p-5 relative overflow-hidden mt-5'>
          <h1 className='text-center mt-5'>Quick Delivery</h1>
          <div className='flex justify-center mt-4'>
            <AiOutlineFieldTime className='text-yellow-500' size={28} />
          </div>
          <p className='text-center mt-10 text-neutral-300'>Enjoy our quick delivery service that gets your order to you in no time.</p>
          <p className='text-center mt-10 mb-7'><a href="#" className='px-4 py-2 rounded-sm border-[0.5px] border-[#363636] shadow-md text-gray-400 hover:text-green-500'>Shop Now</a></p>
          <span className='w-[60px] h-[60px] z-[-2] blur-[100px] left-[45%] bg-white absolute top-0 '></span>
